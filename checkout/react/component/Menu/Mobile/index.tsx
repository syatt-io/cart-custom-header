...
const Mobile = ({ items }: Departaments) => {
    ...
    const prevValue = usePreviousValue(categories)
    ...
    return (
        <section className='container-menu-mobile'>
            ...
            <button className='menu-mobile-hanburguer'>
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="22" viewBox="0 0 22 22" className="svg-icon svg-icon--header-search" data-header-search-trigger-target=""><title>Search</title><path d="M20.347 18.486l-4.366-4.345a8.767 8.767 0 001.751-5.275C17.732 3.99 13.764 0 8.866 0 3.99 0 0 3.968 0 8.866a8.864 8.864 0 0013.809 7.359l4.41 4.41c.289.289.688.444 1.065.444.376 0 .775-.155 1.063-.443a1.553 1.553 0 000-2.15zM3.014 8.866c0-3.236 2.638-5.874 5.852-5.874s5.852 2.638 5.852 5.852c0 3.214-2.616 5.874-5.852 5.874S3.014 12.08 3.014 8.866z"></path></svg>
            </button>
