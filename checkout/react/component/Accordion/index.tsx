const Accordion = () => {
  ...
  if (
    ...
    const totalAmount = document.querySelector<HTMLElement | any>(
      '.new-product-price'
    )?.innerText
    ...
    const accordionPanel = document.querySelector<HTMLElement | any>(
      '.accordion-inner'
    )
    ...
    if (!document.querySelector('.quote-button')) {
      ...
      modalText.innerHTML =
        'To request a quote, simply add the desired items to your cart and continue to checkout. Once at the final payment screen, you will have the option to <b>“REQUEST AN OFFICIAL QUOTE"</b> (if required) or select a payment method and <b>“PLACE ORDER”</b>.'

      modalContent.appendChild(closeIcon)
      modalContent.appendChild(modalText)

      document
        .querySelector<HTMLElement | any>('.cart-links-bottom')
        .appendChild(quoteButton)
