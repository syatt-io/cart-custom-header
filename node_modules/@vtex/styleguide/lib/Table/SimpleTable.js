...
function (_Component) {
  ...
  function SimpleTable(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "calculateContainerHeight", function () {
      ...
      if (items.length === 0) {
        return HEADER_HEIGHT + rowHeight * EMPTY_STATE_SIZE_IN_ROWS + _this.getScrollbarWidth();
      }
      ...
      return rawTableHeight + _this.getScrollbarWidth();
    });
      ...
      return _react2.default.createElement(_reactVirtualized.MultiGrid, {
        ...
        cellRenderer: function cellRenderer(_ref5) {
          ...
          return _react2.default.createElement(_reactVirtualized.CellMeasurer, {
            ...
            var updateCellMeasurements = _ref6.measure;
            return _react2.default.createElement("div", {
              key: key,
              style: _extends({}, style, {
