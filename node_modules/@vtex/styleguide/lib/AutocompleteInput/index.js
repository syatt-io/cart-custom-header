...
var AutocompleteInput = function AutocompleteInput(_ref) {
  var _ref$input = _ref.input,
      ...
      _onSearch = _ref$input.onSearch,
      onChange = _ref$input.onChange,
      inputProps = _objectWithoutPropertiesLoose(_ref$input, ["value", "onClear", "onSearch", "onChange"]),
  ...
  var handleKeyDown = function handleKeyDown(e) {
    if (e.key === 'Enter') {
      ...
      if (selectedOptionIndex !== -1) {
        ...
        _onSearch((0, _Option.getTermFromOption)(selectedOption));
      }
  ...
  var renderOptions = function renderOptions() {
    return _react2.default.createElement("div", {
      ...
      className: "pa4 b f6"
    }, lastSearched.label || 'Last searched terms') : null, showedOptions.map(renderOption ? function (option, index) {
      return renderOption(getOptionProps(option, index), index);
    } : function (option, index) {
      return _react2.default.createElement(_Option2.default, getOptionProps(option, index));
    }));
  };

  var popoverOpened = showPopover && (!!showedOptions.length || loading);
  return _react2.default.createElement("div", {
    ref: containerRef,
