...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var content = _react2.default.createElement(_react2.default.Fragment, null, label && _react2.default.createElement("span", {
      ...
      type: "button",
      className: "br2 pa0 bl-0 flex items-center justify-center " + borderClasses + " " + buttonClasses + " " + (readOnly || isMax ? buttonDisabledClasses : buttonEnabledClasses),
      style: {
      ...
      type: "button",
      className: "br2 pa0 br-0 flex items-center justify-center " + borderClasses + " " + buttonClasses + " " + (readOnly || isMin ? buttonDisabledClasses : buttonEnabledClasses),
      style: {
