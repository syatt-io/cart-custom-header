 ...
 * @param comparator
 */
function getBulkChecked(checked, item, nodesKey, comparator) {
  if (nodesKey === void 0) {
    nodesKey = 'children';
  }

  return [].concat(checked, getFlat(item, [], nodesKey)).reduce(function (acc, item) {
...
function getToggledState(state, item, nodesKey, comparator) {
  if (nodesKey === void 0) {
    nodesKey = 'children';
  }
  ...
  return item[nodesKey] ? getBulkChecked(state, item, nodesKey, comparator) : [].concat(state, [item]);
}
/**
